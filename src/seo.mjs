...
const descriptions={
 ...
 '/work/reggio-projects/':'A decade of Reggio-inspired projects with children in Bangkok: materials, micro:bit, Arduino and AI, facilitated and documented by educator Trevor Cardozo.',
